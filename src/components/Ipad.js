...
const Ipad = () => {
  return (
    <div className="w-full h-[600px] bg-[#fbfbfb] bg-contain relative bg-no-repeat bg-fix bg-bottom">
      <div className="max-w[1000px] h-[600px] flex flex-col lg:flex-row lg:pl-50 items-center z-10">
        <div className="flex flex-col items-center lg:items-end w-1/3 h-1/2  lg:h-full justify-center ">
          <p
            style={{ backgroundImage: `url(${ipadText})` }}
            className="md:w-[180px] md:h-[50px] w-[180px] h-[50px]  z-20 bg-contain bg-no-repeat mg-center"
          ></p>
          <p className="z-20 text-white h-15">Light. Bright. Full of might.</p>
          <div className="z-20 flex w-[200px] justify-between pt-4">
